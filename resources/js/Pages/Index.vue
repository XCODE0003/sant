...
<template>
    <AppLayout title="СантехникаЧелябинск - ВОДА и ТЕПЛО в вашем доме">
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <Link
                                href="/catalog"
                                class="bg-accent hover:bg-yellow-500 text-white px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center"
                            >
                            ...
                            <Link
                                href="/services"
                                class="border-2 border-white hover:bg-white hover:text-primary text-white px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center"
                            >
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                            <div class="grid grid-cols-2 gap-6">
                                <div class="bg-white/20 rounded-xl p-6 text-center">
                                    ...
                                    <p class="text-sm text-blue-100">От 1 дня по Москве</p>
                                </div>
                                <div class="bg-white/20 rounded-xl p-6 text-center">
                                ...
                                <div class="bg-white/20 rounded-xl п-6 text-center">
                                    <i class="fas fa-medal text-4xl mb-4"></i>
                                    <h3 class="font-semibold mb-2">С 2001 года</h3>
                                    <p class="text-sm text-blue-100">Проверенное качество</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-16">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    <h2 class="text-4xl font-bold text-gray-800 mb-4">Популярные категории</h2>
                    <p class="text-xl text-gray-600">Направления, которые выбирают чаще всего</p>
                </div>

                <div v-if="hasTopCategories" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <Link
                    ...
                    >
                        <div class="bg-gradient-to-br from-primary/90 to-secondary/90 p-8 text-center">
                            <i class="fas fa-layer-group text-4xl text-white mb-4"></i>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center mt-6">
                                ...
                                <i class="fas fa-arrow-right text-primary group-hover:translate-x-2 transition-transform"></i>
                            </div>
                        </div>
                    </Link>
                </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    <h2 class="text-4xl font-bold text-gray-800 mb-4">Хиты продаж</h2>
                    <p class="text-xl text-gray-600">
                        Популярные товары, которые выбирают наши клиенты прямо сейчас
                    </p>
                </div>

                <div v-if="hasFeaturedProducts" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div
